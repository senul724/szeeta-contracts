...
contract Factory {
    ...
    // events
    event Created(address address_);
    ...
    function createContract(
        ...
        bytes32 salt = keccak256(abi.encode(msg.sender, randomNo_));
        contractAddress = clone(base, salt);
        IExaminer(contractAddress).initialize(org, receiver_, feeFactor, list_);
